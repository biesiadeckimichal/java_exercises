...
public class Main {
    ...
    public static int solution(int number) {
        int zeroCounter = 0;
        int zeroCounterTemp = 0;
        boolean wasThereOne = false;
        ...
        while (number > 0) {
            if (number % 2 == 0) {
                ...
                wasThereOne = true;
                if (zeroCounterTemp > zeroCounter) {
                    zeroCounter = zeroCounterTemp;
                    zeroCounterTemp = 0;
                }
            }
            number = number / 2;
...
// szukanie kandydata na maksimum min, ekstremumm, bardzo wazny sposob
